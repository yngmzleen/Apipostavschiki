...
# Копирование данных из API и фильтрация по категории "Грузовая"
for item in root.findall('tyres'):
    category = item.find('category')
    if category is not None and category.text.strip() == "Грузовая":
